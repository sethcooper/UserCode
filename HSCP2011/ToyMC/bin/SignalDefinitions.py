class SignalSample:
  def __init__(self,name,crossSection,ptCut,iasCut,massCut):
    self.name = name
...
# GluinoN
GluinoN300 = SignalSample('Gluino300N','65.8',60,'0.400',180)
GluinoN400 = SignalSample('Gluino400N','11.2',85,'0.400',230)
GluinoN500 = SignalSample('Gluino500N','2.54',50,'0.375',290)
GluinoN600 = SignalSample('Gluino600N','0.693',50,'0.350',330)
GluinoN700 = SignalSample('Gluino700N','0.214',50,'0.325',270)
GluinoN800 = SignalSample('Gluino800N','0.0725',50,'0.300',400)
GluinoN900 = SignalSample('Gluino900N','0.0262',95,'0.300',380)
GluinoN1000 = SignalSample('Gluino1000N','0.00987',50,'0.300',410)
GluinoN1100 = SignalSample('Gluino1100N','0.00386',50,'0.275',460)
GluinoN1200 = SignalSample('Gluino1200N','0.00154',50,'0.300',400)
# Stop
...
# StopN
StopN130 = SignalSample('Stop130N','120.0',70,'0.400',70)
StopN200 = SignalSample('Stop200N','13.0',70,'0.400',120)
StopN300 = SignalSample('Stop300N','1.31',70,'0.400',170)
StopN400 = SignalSample('Stop400N','0.218',60,'0.400',240)
StopN500 = SignalSample('Stop500N','0.0478',50,'0.375',280)
StopN600 = SignalSample('Stop600N','0.0125',50,'0.350',320)
StopN700 = SignalSample('Stop700N','0.00356',50,'0.325',350)
StopN800 = SignalSample('Stop800N','0.00114',50,'0.325',370)
# GMSB Stau
