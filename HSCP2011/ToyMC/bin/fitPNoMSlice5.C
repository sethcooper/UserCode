...
fitPNoMSlice5()
{
  ...
  histForPDFNoMPBinsIndex5->Fit("myFunc2","RL+");
  ...
  {
    double funcValBinCenter = myFunc2->Eval(histForPDFNoMPBinsIndex5->GetBinCenter(binx));
    double binEntries = histForPDFNoMPBinsIndex5->GetBinContent(binx);
