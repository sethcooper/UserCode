...
fitPNoMSlice2()
{
  ...
  histForPDFNoMPBinsIndex2->Fit("myFunc2","RL+");
  ...
  {
    double funcValBinCenter = myFunc2->Eval(histForPDFNoMPBinsIndex2->GetBinCenter(binx));
    double binEntries = histForPDFNoMPBinsIndex2->GetBinContent(binx);
