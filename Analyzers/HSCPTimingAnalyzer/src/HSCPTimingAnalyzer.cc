...
// $Id: HSCPTimingAnalyzer.cc,v 1.10 2009/11/04 13:41:18 scooper Exp $
//
//
...
=======
   ...
   energyOfTrackMatchedHitsEB_ = new TH1D("energyOfTrackMatchedHitsEB", "Energy of track-matched hits EB [GeV]",2500,0,10);
   energyOfTrackMatchedHitsEE_ = new TH1D("energyOfTrackMatchedHitsEE", "Energy of track-matched hits EE [GeV]",2500,0,10);
   outOfTimeEnergyOfTrackMatchedHitsEB_ = new TH1F("OOTenergyOfTrackMatchedHitsEB", "OOT Energy of track-matched hits EB [GeV]",2500,0,10);
   outOfTimeEnergyOfTrackMatchedHitsEE_ = new TH1F("OOTenergyOfTrackMatchedHitsEE", "OOT Energy of track-matched hits EE [GeV]",2500,0,10);
   //timeOfTrackMatchedHits_ = new TH1D("timeOfTrackMatchedHits", "Time of track-matched hits [ns]",500,-25,25);
   timeOfTrackMatchedHitsEB_ = new TH1D("timeOfTrackMatchedHitsEB", "Time of track-matched hits EB [ns]",500,-25,25);
   timeOfTrackMatchedHitsEE_ = new TH1D("timeOfTrackMatchedHitsEE", "Time of track-matched hits EE [ns]",500,-25,25);
   ...
   timeOfTrackMatchedHitsEB1GeVcut_ = new TH1F("timeOfTrackMatchedHitsEB1GeVcut", "Time of track-matched hits EB > 1 GeV [ns]",500,-25,25);
   timeOfTrackMatchedHitsEB3GeVcut_ = new TH1F("timeOfTrackMatchedHitsEB3GeVcut", "Time of track-matched hits EB > 3 GeV [ns]",500,-25,25);
   timeOfTrackMatchedHitsEB5GeVcut_ = new TH1F("timeOfTrackMatchedHitsEB5GeVcut", "Time of track-matched hits EB > 5 GeV [ns]",500,-25,25);
   timeOfTrackMatchedHitsEE1GeVcut_ = new TH1F("timeOfTrackMatchedHitsEE1GeVcut", "Time of track-matched hits EE > 1 GeV [ns]",500,-25,25);
   timeOfTrackMatchedHitsEE3GeVcut_ = new TH1F("timeOfTrackMatchedHitsEE3GeVcut", "Time of track-matched hits EE > 3 GeV [ns]",500,-25,25);
   timeOfTrackMatchedHitsEE5GeVcut_ = new TH1F("timeOfTrackMatchedHitsEB5GeVcut", "Time of track-matched hits EE > 5 GeV [ns]",500,-25,25);
   
   timeVsEnergyOfTrackMatchedHitsEB_ = new TH2D("timeVsEnergyOfTrackMatchedHitsEB","Time [ns] vs. energy [GeV] for track-matched hits EB",2500,0,10,500,-25,25);
   timeVsEnergyOfTrackMatchedHitsEE_ = new TH2D("timeVsEnergyOfTrackMatchedHitsEE","Time [ns] vs. energy [GeV] for track-matched hits EE",2500,0,10,500,-25,25);

   timeChi2VsEnergyOfTrackMatchedHitsEB_ = new TH2F("timeChi2VsEnergyOfTrackMatchedHitsEB","TimeChi2 vs. energy [GeV] for track-matched hits EB",2500,0,10,1000,0,1000);
   timeChi2VsEnergyOfTrackMatchedHitsEE_ = new TH2F("timeChi2VsEnergyOfTrackMatchedHitsEE","TimeChi2 vs. energy [GeV] for track-matched hits EE",2500,0,10,1000,0,1000);
...
=======
   energy1OverEnergy9Hist_ = new TH1F("e1OverE9","Energy of matched xtal over 3x3 energy",44,0,1.1);
   energy1VsE1OverE9Hist_ = new TH2F("e1VsE1OverE9","Energy of matched xtal vs e1/e9;;[GeV]",44,0,1.1,2500,0,10);
   energy9VsE1OverE9Hist_ = new TH2F("e9VsE1OverE9","Energy of 3x3 xtal array vs e1/e9;;[GeV]",44,0,1.1,2500,0,10);
...
>>>>>>> 1.10
   ...
   timeError999EnergyHist_ = new TH1F("energyOfHitsWithError999", "Energy of track-matched hits EB with error 999 [GeV]",2500,0,10);

   timePullDistEBHist_ = new TH1F("pullDistTimeEB","Pull of time, EB",200,-10,10);
   timePullDistEEHist_ = new TH1F("pullDistTimeEE","Pull of time, EE",200,-10,10);

   TsigTvsArmsEBHist_ = new TH2F("TsigTvsArmsEB","t/#sigma_{t} vs. A/1.26 ADC EB",2000,0,1000,200,-10,10);
   TsigTvsArmsEEHist_ = new TH2F("TsigTvsArmsEE","t/#sigma_{t} vs. A/2.87 ADC EE",2000,0,1000,200,-10,10);

   energyVsDeDxHist_ = new TH2F("energyVsDeDx","energyVsDeDx;dE/dx [MeV/cm];energy [GeV]",140,0,70,250,0,1);
   for(int i=0;i<25;++i)
   {
     std::string name="energyInDeDxSlice_";
     name+=intToString(i);
     energyInDeDxSlice_[i] = new TH1F(name.c_str(),name.c_str(),250,0,1);
   }
...
HSCPTimingAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  if(!recoTracks->size() > 0)
  {
    ...
    //XXX Turn off for testing on data
    return;
  }
