...
int main(int argc, char* argv[])
{
  ...
  RooRealVar hscpEnergyMean2d("E_mean2d","E_mean2d",0.5,0.1,1.0);
  RooRealVar hscpEnergySigma2d("E_sigma2d","E_sigma2d",0.06,0,0.1);

  RooRealVar hscpTimeMean2d("T_mean2d","T_mean2d",6.0,-5.0,5.0);
  ...
  RooGaussian* hscpTime = new RooGaussian("hscpTime","hscpTime",time,hscpTimeMean2d,timingRes);
  RooGaussian* hscpEnergy = new RooGaussian("hscpEnergy","hscpEnergy",energy,hscpEnergyMean2d,hscpEnergySigma2d);
  RooProdPdf energyAndTimeModel("energyAndTimeBackModel","energyAndTimeBackModel",*hscpEnergy,Conditional(*hscpTime,time));

  // 1-D model vars -- signal
  RooRealVar gaussianEnergyMean1("E_hgMean1","E_hgMean1",0.5,0.1,1.0);
  RooRealVar gaussianEnergySigma1("E_hgSigma1","E_hgSigma1",0.06,0,0.1);
  RooRealVar gaussianTimeHSCPsMean1("T_hMean1","T_hMean1",6.0,-10.0,10.0);
  RooRealVar gaussianTimeHSCPsSigma1("T_hSigma1","T_hSigma1",2.0,0.1,6.0);
  RooGaussian* hscpEnergyModel1D = new RooGaussian("gaussianEnergy1D","gaussianEnergy1D",energy,gaussianEnergyMean1,gaussianEnergySigma1);
  RooGaussian* hscpTimeModel1D = new RooGaussian("gaussianTimeHSCPs1D","gaussianTimeHSCPs1D",time,gaussianTimeHSCPsMean1,gaussianTimeHSCPsSigma1);
  ...
  RooNLLVar nll("nll","nll",energyAndTimeModel,*energyTimeData);
  RooMinuit m(nll);
  //m.setErrorLevel(0.5);
  m.setStrategy(2);
  //m.hesse();
  ...
  hscpEnergyModel1D->fitTo(*energyData);
  hscpTimeModel1D->fitTo(*timeData);

  TFile output("myLikelihoodOutput_signal.root","RECREATE");
  ...
  energyAndTimeModel.plotOn(frame,ProjectionRange("signal"));
  energyAndTimeModel.paramOn(frame);
  frame->Draw("e0");
  ...
  energyAndTimeModel.plotOn(frame2,ProjectionRange("signal"));
  energyAndTimeModel.paramOn(frame2);
  frame2->Draw("e0");
  ...
  energyAndTimeModel.plotOn(frame3,ProjectionRange("signal"));
  energyAndTimeModel.paramOn(frame3);
  frame3->Draw("e0");
  ...
  energyAndTimeModel.plotOn(frame4,ProjectionRange("signal"));
  energyAndTimeModel.paramOn(frame4);
  frame4->Draw("e0");
  ...
  energyAndTimeModel.plotOn(frame5,ProjectionRange("signal"));
  energyAndTimeModel.paramOn(frame5);
  frame5->Draw("e0");
  ...
  hscpEnergyModel1D->plotOn(energyFrame2);
  hscpEnergyModel1D->paramOn(energyFrame2,Layout(0.55));
  energyFrame2->Draw("e0");
  combinedCanvas1D->cd(2);
  RooPlot* timeFrame2 = time.frame();
  timeData->plotOn(timeFrame2);
  hscpTimeModel1D->plotOn(timeFrame2);
  hscpTimeModel1D->paramOn(timeFrame2,Layout(0.7));
  timeFrame2->Draw("e0");
  //Print
