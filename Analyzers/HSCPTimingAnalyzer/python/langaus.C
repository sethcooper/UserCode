...
TF1 *langaufit(TH1D *his, Double_t *fitrange, Double_t *startvalues, Double_t *parlimitslo, Double_t *parlimitshi, Double_t *fitparams, Double_t *fiterrors, Double_t *ChiSqr, Int_t *NDF,char * opts="RB0")
{
...
void langaus( TH1D *poHist) {
  ...
  pllo[0]=0.0001; pllo[1]=10.0; pllo[2]=1.0; pllo[3]=1.0;
  plhi[0]=10.0; plhi[1]=20.0; plhi[2]=1000000.0; plhi[3]=10.0;
  sv[0]=1; sv[1]=15; sv[2]=800.0; sv[3]=3;
...
void langausN( TH1D *poHist,double start=0, double stop=0) {
  // Fill Histogram
  printf("Fitting...\n");
...
void langausN( TH1D *poHist,Double_t& SNRPeak,Double_t& SNRFWHM,double start=0, double stop=0,bool draw=false, char* opts="RB0") {
  // Fill Histogram
  printf("Fitting...\n");
