...
process.MessageLogger = cms.Service("MessageLogger",
    ...
    suppressError = cms.untracked.vstring('ecalAnalFitUncalibRecHit')
)
...
process.load("RecoLocalCalo.EcalRecProducers.ecalAnalFitUncalibRecHit_cfi")
...
process.testBeamTimingAnalyzer.hitProducer = "ecalAnalFitUncalibRecHit"
process.ecalAnalFitUncalibRecHit.EBdigiCollection = 'ecalTBunpack:ebDigis'
process.ecalAnalFitUncalibRecHit.EEdigiCollection = 'ecalTBunpack:eeDigis'
...
process.ecalAnalFitUncalibRecHit *
#  process.ecalRecHit *
