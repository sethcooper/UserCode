...
// $Id: EcalCosmicTimingAnalyzer.h,v 1.1 2008/08/11 16:37:44 scooper Exp $
//
//
...
class EcalCosmicTimingAnalyzer : public edm::EDAnalyzer {
   public:
      explicit EcalCosmicTimingAnalyzer(const edm::ParameterSet&);
  ...
  TH1F* matchedEnergyHist_;
  TH1F* matchedTimeHist_;
