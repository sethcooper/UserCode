...
class CosmicsTiming : public edm::EDAnalyzer {
   public:
      explicit CosmicsTiming(const edm::ParameterSet&);
      ~CosmicsTiming();
  ...
  //scooper
  //S. Cooper
  TH1F* timingDeltaHist_;
  TH1F* selectedCryEnergyHist_;
  TH1F* selectedCryTimeHist_;
  TH1F* selectedCryRunHist_;
