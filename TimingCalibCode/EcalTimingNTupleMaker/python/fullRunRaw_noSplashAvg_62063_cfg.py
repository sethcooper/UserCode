...
process.source = cms.Source("PoolSource",
   ...
   'file:/data/scooper/data/beamHaloSkimsSept2008/Run62063_EcalHighEnergySkim_RAW.root'
   )
)
...
process.ecalTimingNTupleMaker.rootfile = "RawTimingPhysics_FullRun.62063.root"
