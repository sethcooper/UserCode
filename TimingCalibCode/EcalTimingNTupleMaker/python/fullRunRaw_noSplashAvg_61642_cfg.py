...
process.ecalTimingNTupleMaker.recHitCollection = cms.InputTag("ecalRecHit","EcalRecHitsEB")
process.ecalTimingNTupleMaker.recHitCollectionEE = cms.InputTag("ecalRecHit","EcalRecHitsEE")
process.ecalTimingNTupleMaker.CorrectEcalReadout = False
process.ecalTimingNTupleMaker.CorrectBH = False
process.ecalTimingNTupleMaker.BeamHaloPlus = False
process.ecalTimingNTupleMaker.CorrectAverage = False
process.ecalTimingNTupleMaker.rootfile = "RawTimingPhysics_FullRun.61642.root"
