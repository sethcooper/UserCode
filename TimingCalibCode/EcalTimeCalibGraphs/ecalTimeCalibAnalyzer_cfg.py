...
process.source = cms.Source("PoolSource",
    ...
    skipEvents = cms.untracked.uint32(0),  # SKIP 6 EVENTS FOR RUN 62068!!
...
process.ecalTimeCalibAnalyzer = cms.EDAnalyzer("EcalTimeCalibAnalyzer",
    applyCalibration = cms.untracked.bool(False),
...
process.TFileService.fileName = 'ecalTimeCalibAnalyzer_61642_noCalibs.root'
